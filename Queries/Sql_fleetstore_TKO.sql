/****** Script for SelectTopNRows command for TAKEOFF  ******/
SELECT 
  ...
  FROM [A330Neo-Trent7000].[Takeoff-AircraftEngine-DA] AS DA
  JOIN [A330Neo-Trent7000].[Takeoff-AircraftEngine-EPS] AS EPS
  ON 
  ...
  where DA.deleted = 0 AND EPS.deleted = 0 AND DA.[StartDatetime] >= %startTimestamp%  
